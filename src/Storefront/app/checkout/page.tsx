  ...
  return (
    <div className="max-w-xl mx-auto space-y-6">
      ...
      <div className="rounded-md border border-neutral-200 p-4 text-sm">
        ...
        <p className="mt-1 text-neutral-500">Choose a shipping rate before authorization; tax is estimated below from the storefront currency and shipping region.</p>
      </div>
