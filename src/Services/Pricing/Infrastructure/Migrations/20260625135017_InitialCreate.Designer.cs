...
namespace ThreeCommerce.Pricing.Infrastructure.Migrations
{
    ...
    [Migration("20260625135017_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MassTransit.EntityFrameworkCoreIntegration.OutboxMessage", b =>
                {
                    ...
                    b.ToTable("OutboxMessage", "pricing");
                });
            ...
            modelBuilder.Entity("MassTransit.EntityFrameworkCoreIntegration.OutboxState", b =>
                {
                    ...
                    b.ToTable("OutboxState", "pricing");
                });

            modelBuilder.Entity("ThreeCommerce.Pricing.Domain.Price", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ThreeCommerce.Pricing.Domain.PriceTier", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ThreeCommerce.Pricing.Domain.PriceTier", b =>
                {
                    b.HasOne("ThreeCommerce.Pricing.Domain.Price", null)
                        .WithMany("Tiers")
