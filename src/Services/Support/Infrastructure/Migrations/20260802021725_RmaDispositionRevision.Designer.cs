...
namespace ThreeCommerce.Support.Infrastructure.Migrations
{
    ...
    [Migration("20260802021725_RmaDispositionRevision")]
    partial class RmaDispositionRevision
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThreeCommerce.Support.Domain.RmaDisposition", b =>
                {
                    ...
                    b.Property<string>("StorageReason")
                        .HasMaxLength(16)
                        .HasColumnType("character varying(16)");
                    ...
                    b.ToTable("RmaDispositions", "support");
                });

            modelBuilder.Entity("ThreeCommerce.Support.Domain.RmaRequestLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("RmaRequestLines", "support");
                });

            modelBuilder.Entity("ThreeCommerce.Support.Domain.RmaRequestRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("RmaRequests", "support");
                });

            modelBuilder.Entity("ThreeCommerce.Support.Domain.SupportAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ThreeCommerce.Support.Domain.RmaRequestLine", b =>
                {
                    b.HasOne("ThreeCommerce.Support.Domain.RmaRequestRecord", null)
                        .WithMany("Lines")
                        .HasForeignKey("RmaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
