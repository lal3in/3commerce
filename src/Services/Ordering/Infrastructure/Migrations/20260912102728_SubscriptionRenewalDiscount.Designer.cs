...
namespace ThreeCommerce.Ordering.Infrastructure.Migrations
{
    ...
    [Migration("20260912102728_SubscriptionRenewalDiscount")]
    partial class SubscriptionRenewalDiscount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThreeCommerce.Ordering.Domain.CheckoutAttemptLine", b =>
                {
                    ...
                    b.Property<long>("RenewalDiscountMinor")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ThreeCommerce.Ordering.Domain.OfferCopy", b =>
                {
                    ...
                    b.ToTable("OfferCopies", "ordering");
                });
            ...
            modelBuilder.Entity("ThreeCommerce.Ordering.Domain.ProductVariantCopy", b =>
                {
                    ...
                    b.ToTable("ProductVariantCopies", "ordering");
                });

            modelBuilder.Entity("ThreeCommerce.Ordering.Domain.ProductVariantCopyPrice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ThreeCommerce.Ordering.Domain.PromotionCopy", b =>
                {
                    ...
                    b.Property<bool>("AppliesToRenewals")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("ThreeCommerce.Ordering.Domain.PromotionRedemption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PromotionId", "CustomerKey");

                    b.HasIndex("PromotionId", "OrderId")
                        .IsUnique();

                    b.ToTable("PromotionRedemptions", "ordering");
                });
            ...
            modelBuilder.Entity("ThreeCommerce.Ordering.Domain.StorefrontTaxCopy", b =>
                {
                    ...
                    b.Property<int>("DiscountBasisPoints")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ThreeCommerce.Ordering.Domain.VerifiedCustomerCopy", b =>
                {
                    ...
                    b.ToTable("VerifiedCustomerCopies", "ordering");
                });
            ...
            modelBuilder.Entity("ThreeCommerce.Ordering.Domain.ProductVariantCopy", b =>
                {
                    b.HasOne("ThreeCommerce.Ordering.Domain.ProductCopy", null)
                        .WithMany("Variants")
            ...
            modelBuilder.Entity("ThreeCommerce.Ordering.Domain.ProductVariantCopyPrice", b =>
                {
                    b.HasOne("ThreeCommerce.Ordering.Domain.ProductVariantCopy", null)
                        .WithMany("Prices")
