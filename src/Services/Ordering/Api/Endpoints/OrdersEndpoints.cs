        ...
        ClaimsPrincipal user, OrderingDbContext db, CancellationToken ct)
    {
        ...
        var orders = await db.Orders.AsNoTracking()
            ...
            .Select(o => new OrderSummary(o.Id, o.Status.ToString(), o.GrossMinor, o.Currency, o.CreatedAt,
                string.IsNullOrEmpty(o.PaymentOption) ? "CreditCard" : o.PaymentOption, o.StorefrontId))
            .ToListAsync(ct);
...
public record OrderSummary(Guid Id, string Status, long GrossMinor, string Currency, DateTimeOffset CreatedAt, string PaymentOption = "CreditCard", Guid? StorefrontId = null);
