...
namespace ThreeCommerce.Payments.Infrastructure.Migrations
{
    ...
    [Migration("20260810065006_SubscriptionAutoRenew")]
    partial class SubscriptionAutoRenew
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThreeCommerce.BuildingBlocks.Infrastructure.Scheduling.ScheduleOverride", b =>
                {
                    ...
                    b.ToTable("ScheduleOverrides", "payments");
                });
            ...
            modelBuilder.Entity("ThreeCommerce.Payments.Domain.Ledger.JournalLine", b =>
                {
                    ...
                    b.HasIndex("AccountCode", "Currency");
            ...
            modelBuilder.Entity("ThreeCommerce.Payments.Domain.Ledger.StorefrontLedgerAccounts", b =>
                {
                    ...
                    b.ToTable("StorefrontLedgerAccounts", "payments");
                });

            modelBuilder.Entity("ThreeCommerce.Payments.Domain.Mandate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ThreeCommerce.Payments.Domain.PaymentAccount", b =>
                {
                    ...
                    b.Property<bool>("IsDefaultForStorefront")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("TenantId", "StorefrontId", "IsDefaultForStorefront");
            ...
            modelBuilder.Entity("ThreeCommerce.Payments.Domain.StorefrontBillingSchedule", b =>
                {
                    b.Property<Guid>("StorefrontId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<TimeOnly>("DailyRunTime")
                    ...
                    b.ToTable("StorefrontBillingSchedules", "payments");
                });
            ...
            modelBuilder.Entity("ThreeCommerce.Payments.Domain.Subscription", b =>
                {
                    ...
                    b.HasIndex("StorefrontId", "Status", "CurrentPeriodEnd");

                    b.ToTable("Subscriptions", "payments");
                });

            modelBuilder.Entity("ThreeCommerce.Payments.Domain.SubscriptionRenewal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SubscriptionId", "Sequence")
                        .IsUnique();

                    b.ToTable("SubscriptionRenewals", "payments");
                });
            ...
            modelBuilder.Entity("ThreeCommerce.Payments.Domain.VoidPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("VoidPayments", "payments");
                });
            ...
            modelBuilder.Entity("ThreeCommerce.Payments.Domain.SubscriptionRenewal", b =>
                {
                    b.HasOne("ThreeCommerce.Payments.Domain.Subscription", null)
                        .WithMany("Renewals")
