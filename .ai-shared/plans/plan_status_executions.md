...
| mt2_7 | Admin/CLI entity and supplier management | Phase 2 entity/supplier | in_progress | .ai-shared/plans/multi-tenant-platform-expansion-phase-2-entity-supplier.md | 7a/7b supplier change-request lifecycle DONE; 7c customer↔entity link/de-link DONE (CustomerEntityLink many-to-many typed roles, effective-dated, no-duplicate-active filtered unique index, 8 tests; service + 4 endpoints link/list-by-entity/list-by-customer/unlink). Entity tests 46. PENDING: Admin entities/suppliers page + tenant selector, CLI entity/supplier commands |
