...
Last Modified Date-Time: 2026-06-24 (mt4_1b done [supply seam]; mt4_2 reservation engine + movement ledger + stock-collapse done [only mt7_1-blocked saga-wiring remains]; mt4_3 done [carrier integration model + lifecycle + storefront overrides])
